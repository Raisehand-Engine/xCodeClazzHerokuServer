...
const image_containers = {
    image_container_xcodeclazz: 'xcodeclazz'
}
...
// Sequency, [differenciate this routes a little because we have more actors in XCodeClazz eco system]
...
let headerxcodeclazz = 'route_caller_xcodeclazz';
let headerAppVersion = 'app_version';
let headerServerVersion = 'server_version';

const envRouteCommonHeaders = { [headerAccessPlatformArray]: [PLATFORMS.WINDOWS, PLATFORMS.DESKTOP], [headerxcodeclazz]: APP_NAMES.CONTRIBUTOR, [headerAppVersion]: APP_VERSIONS.android_env.latest, [headerServerVersion]: serverVersion }
const endRouteCommonHeaders = { [headerAccessPlatformArray]: [PLATFORMS.WINDOWS, PLATFORMS.DESKTOP], [headerxcodeclazz]: APP_NAMES.END, [headerAppVersion]: APP_VERSIONS.android_env.latest, [headerServerVersion]: serverVersion }
const spclRouteCommonHeaders = { [headerAccessPlatformArray]: [PLATFORMS.WINDOWS, PLATFORMS.DESKTOP], [headerxcodeclazz]: APP_NAMES.ADMIN, [headerAppVersion]: APP_VERSIONS.android_admin.latest, [headerServerVersion]: serverVersion }
const shopRouteCommonHeaders = { [headerAccessPlatformArray]: [PLATFORMS.WINDOWS, PLATFORMS.DESKTOP], [headerxcodeclazz]: APP_NAMES.SHOP, [headerAppVersion]: APP_VERSIONS.android_shop.latest, [headerServerVersion]: serverVersion }
const employeeRouteCommonHeaders = { [headerAccessPlatformArray]: [PLATFORMS.WINDOWS, PLATFORMS.DESKTOP], [headerxcodeclazz]: APP_NAMES.EMPLOYEE, [headerAppVersion]: APP_VERSIONS.android_employee.latest, [headerServerVersion]: serverVersion }

// Any app can access these routes
const helperRouteCommonHeaders = { [headerAccessPlatformArray]: [PLATFORMS.WINDOWS, PLATFORMS.DESKTOP], [headerxcodeclazz]: APP_NAMES.CONTRIBUTOR, [headerAppVersion]: APP_VERSIONS.android_env.latest, [headerServerVersion]: serverVersion }
const commonRouteCommonHeaders = { [headerAccessPlatformArray]: [PLATFORMS.WINDOWS, PLATFORMS.DESKTOP], [headerxcodeclazz]: APP_NAMES.CONTRIBUTOR, [headerAppVersion]: APP_VERSIONS.android_env.latest, [headerServerVersion]: serverVersion }
